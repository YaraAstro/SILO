...
export const siloApi = {
  ...
  exportLogs: (range: string, dirPath?: string) => invoke<ExportResult>("export_logs", { range, dirPath }),
  exportUsageData: (range: string, dirPath?: string) => invoke<ExportResult>("export_usage_data", { range, dirPath }),
